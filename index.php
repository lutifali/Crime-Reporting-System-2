...
<div class="container" id="wrapper">
    <div id="header">
        <div class="mainLogo">
            <div class="logo"> Crime <span> Reporting System</span></div>
        </div>
        <div id="login">
    ...
    <div id="main">
        <div class="row" id="slider-background">
            ...
            overflow: hidden;">
                        ...
                        <div>
                            <img u="image" src="assets/images/1.jpg" />
                            <div u="thumb">
                                <img class="i" src="assets/images/3.jpg" />
                                <div class="t">Police Training</div>
                                <div class="c">Anti-riot police during training</div>
                            </div>
                        </div>
                        <div>
                            <img u="image" src="assets/images/2.jpg" />
                            <div u="thumb">
                                <img class="i" src="assets/images/1.jpg" />
                                <div class="t">Guard of Honour</div>
                                <div class="c">Police during an official function</div>
                            </div>
                        </div>
                        <div>
                            <img u="image" src="assets/images/3.jpg" />
                            <div u="thumb">
                                <img class="i" src="assets/images/4.webp" />
                                <div class="t">Anti-Riot Police</div>
                                <div class="c">Responding to Hostile situation</div>
                            </div>
                        </div>
                        <div>
                            <img u="image" src="assets/images/4.webp" />
                            <div u="thumb">
                                <img class="i" src="assets/images/3.jpg" />
